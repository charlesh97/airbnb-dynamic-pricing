...
def cmd_push(args: argparse.Namespace) -> None:
    ...
    for uid in uids:
        ...
        console.print(f"    blocks  : [green]{result.availability_updates_sent - result.availability_unblocks_sent}[/green]")
        console.print(f"    unblocks: [green]{result.availability_unblocks_sent}[/green]")
